...
> Part of [`jev-experiments`](../README.md). The sibling [`prism/`](../prism/)
> track is a separate Jev experiment (sensitive-data detection + masking).
> Run HALO from the repo root with the `halo:*` npm scripts (e.g. `npm run halo:serve`).
